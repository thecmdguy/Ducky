...
class DuckyMainWindow(QMainWindow):
    ...
    def _open_donation_link(self):
        url = QUrl("https://ko-fi.com/thecmdguy")
        QDesktopServices.openUrl(url)

    @Slot()
    def _show_about_dialog(self):
        about_text = """
        <h2>Ducky: Ultimate Networking & Security Tool</h2>
        <p>Version 1.3</p>
        <p>If you find this tool useful, please consider supporting the developer.</p>
        <p><a href='https://ko-fi.com/thecmdguy'>Support on Ko-fi</a></p>
        """
        QMessageBox.about(self, "About Ducky", about_text)
